...
import Login from '../../../adm_f/component/Login/Login';
...
function MainPage() {
  ...
  const handleAdminLogin = (adminId) => {
    // 관리자 로그인 성공 후 처리는 Login 컴포넌트 내에서 이루어집니다.
  };
  ...
  return (
    <div className="main-container">
      <div className="auth-button-container">
        ...
        <button className="auth-button adm-login-btn" onClick={() => setIsAdminPopupOpen(true)}>관리자 로그인</button>
      </div>
        ...
        <>
          ...
          <div className="horizontal-container">
            <LoanTemperaturePoint userData={userData} 
              onLoanClick={() => navigate("/loan-application")}
            />
