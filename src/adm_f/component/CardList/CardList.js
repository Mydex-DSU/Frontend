...
const CardList = () => {
  ...
  const visiblePrograms = programs.slice(currentIndex * 4, (currentIndex + 1) * 4);

  return (
    <div className="adm_program-section">
      <h2 className="adm_section-title">비교과 프로그램 목록</h2>
      <div className="adm_slider-wrapper">
        <button className="adm_slider-button adm_prev" onClick={prevSlide}>
          &lt;
        </button>
        ...
        <button className="adm_slider-button adm_next" onClick={nextSlide}>
          &gt;
        </button>
      </div>
